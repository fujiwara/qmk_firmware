...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
     * |  F5  |  F6  | Ctrl |   A  |   S  |   D  |   F  |   G  |      |   H  |   J  |   K  |   L  |   ;  |   "  | Enter| Enter|
     * |------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
     * |  F7  |  F8  | Shift|   Z  |   X  |   C  |   V  |   B  |      |   N  |   M  |   ,  |   .  |   /  |   `  |  Up  | Shift|
     * |------+------+------+------+------+------+------+------|      |------+------+------+------+------+------+------+------|
     * |  F9  |  F10 | Ctrl | GUI  | Alt  | MHEN | Space| Space|      | Enter| Bksp | HENK |  Alt |Adjust| Left | Down | Right|
     * `-------------------------------------------------------'      `-------------------------------------------------------'
     */
  [_QWERTY] = LAYOUT(
      ...
      KC_F5,   KC_F6,   KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT,
      KC_F7,   KC_F8,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV,  KC_UP,   KC_RSFT,
      KC_F9,   KC_F10,  KC_LCTL, KC_LALT, KC_LGUI, KC_MHEN, KC_SPC,  KC_SPC,     KC_ENT,  KC_BSPC, KC_HENK, KC_RALT, ADJUST,  KC_LEFT, KC_DOWN, KC_RGHT
      ),
